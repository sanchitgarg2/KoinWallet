...
public class Helper {
    ...
    public static String addURL="add";
    public static String tradeURL="Trade";
    public static String watchlistURL="getWatchList";
    public static String updatewatchlistURL="updateWatchList";
    public static String CurrencyListURL="getCurrencyList";
